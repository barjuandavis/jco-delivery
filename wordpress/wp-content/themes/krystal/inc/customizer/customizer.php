...
function krystal_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'       => 'krystal_page_settings',
            'type'          => 'checkbox',
            'label'         => __( 'Hide Page Title Section:', 'krystal' ),
            'description'   => '',           
        )
    );
    ...
    $wp_customize->add_control(
        ...
        'kr_cf_label_color',
        array(
        'label'      => __( 'Contact Form Label Color', 'krystal' ),
        'section'    => 'krystal_color_settings',
    ...
    $wp_customize->add_control(
        ...
        'kr_cf_text_color',
        array(
        'label'      => __( 'Contact Form Text Color', 'krystal' ),
        'section'    => 'krystal_color_settings',
    ...
    $wp_customize->add_control(
        ...
        'kr_cf_bg_color',
        array(
        'label'      => __( 'Contact Form Elements Background Color', 'krystal' ),
        'section'    => 'krystal_color_settings',
    ...
    $wp_customize->add_control(
        ...
        'kr_cf_button_color',
        array(
        'label'      => __( 'Contact Form Button Color', 'krystal' ),
        'section'    => 'krystal_color_settings',
    ...
    $wp_customize->add_section(
        ...
        array (
            ...
            'capability'    => 'edit_theme_options',
            'theme_supports'=> '',
            'title'         => __( 'Form Settings', 'krystal' )
        )
    ); 
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'type'          => 'radio',
            'label'         => __( 'Select Form Elements Style:', 'krystal' ),
            'description'   => '',
            'choices' => array(
                            'default' => __( 'Default Style', 'krystal' ),
                            'bg' =>__( 'Solid Background Style', 'krystal' ),
                            ),
        )
    );
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'       => 'krystal_form_settings',
            'type'          => 'checkbox',
            'label'         => __( 'Enable Full Width Form', 'krystal' ),
            'description'   => '',           
        )
    );
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'description'   => __( 'Copyright text to be displayed in the footer.', 'krystal' )
        )
    );   
